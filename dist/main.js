...
function headerCreator() {
  ...
  tabs.forEach(element => {
    docFrag.querySelector("header").appendChild(toHTML(
      "<div class=\"tabs\">" + element + "</div>"));
  })
...
pageFrag.appendChild(headerCreator());
pageFrag.appendChild(bodyCreator());
nukePage();
document.querySelector('.content').appendChild(pageFrag);
